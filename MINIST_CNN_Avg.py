...
class Model():
    ...
    def forward(self, x, label):
        ...
        pool1_out = self.avgpool1.forward(conv1_out)
        conv2_out = self.relu2.forward(self.conv2.forward(pool1_out))
        pool2_out = self.avgpool2.forward(conv2_out)
    ...
    def SGD(self):
        ...
        self.conv1.SGD(self.relu1.SGD(self.avgpool1.SGD(
                        self.conv2.SGD(self.relu2.SGD(self.avgpool2.SGD(
...
if __name__ == "__main__":
    ...
    if not os.path.exists(logpath):
        os.mkdir(logpath)
    logdir = logpath + '/AvgPooling_log.txt'
    print_freq = 50
    val_freq = 200
    DL = DataLoader()
    ...
    with open(logdir, 'w') as logf:
        for epoch in range(20):
            ...
            with open("AvgPooling.pickle", "wb") as fp:   #Pickling
