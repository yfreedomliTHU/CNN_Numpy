...
import time
import pickle
from my_torch import Conv2D, Relu, LRelu, Linear, MaxPooling2D, AvgPooling2D, CrossEntropyLoss, MobileNet_CNN_5x12, MobileNet_CNN_3x24
...
class Model():
    ...
    def backward(self, learning_rate):
        ...
        self.conv2.backward(lr_=learning_rate, weight_decay_=0.0004)
        self.conv1.backward(lr_=learning_rate, weight_decay_=0.0004)
...
if __name__ == "__main__":
    ...
    if not os.path.exists(logpath):
        os.mkdir(logpath)
    logdir = logpath + '/MobileNet_log.txt'
    print_freq = 50
    val_freq = 200
    DL = DataLoader()
    ...
    with open(logdir, 'w') as logf:
        for epoch in range(20):
            ...
            with open("MobileNet.pickle", "wb") as fp:   #Pickling
            ...
            learning_rate = learning_rate_exponential_decay(1e-2, epoch, 0.1, 10)
